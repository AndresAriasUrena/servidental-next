...
// Ejecutar con: claude generate-types.ts
...
// Función para extraer tipos de un objeto
function extractTypeFromObject(obj: any, name: string): string {
...
// Función para determinar el tipo TypeScript de un valor
...
async function generateTypes() {
  ...
  try {
    ...
    const categoriesResponse = await WooCommerce.get('products/categories', { per_page: 10 });
...
// Do not edit manually - run 'claude generate-types.ts' to regenerate
...
`;
    ...
    console.log('   2. Ejecutar: claude create-ecommerce-components.ts');
    console.log('   3. Actualizar imports en componentes existentes');
