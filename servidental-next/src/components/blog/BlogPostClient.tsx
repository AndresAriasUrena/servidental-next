        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-4">
              <li>
                <div>
                  <button onClick={() => router.push('/')} className="text-gray-400 hover:text-gray-500 no-underline">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <button onClick={() => router.push('/blog')} className="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700 no-underline">
                    Blog
                  </button>
                </div>
              </li>
